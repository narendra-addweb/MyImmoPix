...
<article id="post-<?php the_ID(); ?>"  <?php post_class(); ?>>
	...
	?>
       ...
       <div class="row topmargin">  <div class="col-lg-12 col-md-12">
            ...
            <div class="col-lg-3 col-md-3"><strong><?php echo get_str_closetxt()?><?php echo '&nbsp;'. $val;?> </strong></div>
            <div class="col-lg-3 col-md-3"></div>
				...
				if(!empty($newimageid))
				{
					...
					$full_image = wp_get_attachment_image_src( $newimageid, 'full');
				}
				?>
        ...
        <div class="row topmargin"><div class="col-lg-12 col-md-12">
                ...
                <span class="imgid" ><strong><?php echo '#'.get_the_id();?></strong></span><span>&nbsp;&nbsp;<strong>Origional</strong></span></div>
                <div class="col-lg-6 col-md-6 divimage mainlink" id="">
               	
                <a href="<?php echo get_bloginfo("url") ?>downloadimg.php?img=<?php echo str_replace(get_bloginfo("url"),"",$new_feat_image); ?>">
      <img src="<?php echo $full_image[0] ?>" style="padding:10px 10px 2px 10px"  /><?php echo get_str_downloadimg()?></a>
