        ...
        $feat_image =  wp_get_attachment_url( get_the_ID() );
				...
				?><div class="row topmargin">
             	...
             	<div class="col-lg-6 col-md-6 divimage" id="div<?php echo get_the_id();?>">
             		...
             		<span class="imgid" ><strong><?php echo '#'.get_the_id();?></strong></span><span>&nbsp;&nbsp;<strong>Origional</strong></span>
             	</div>
              <div class="col-lg-6 col-md-6 divimage mainlink" id="">
             		<a href="<?php echo get_bloginfo("url") ?>/downloadimg.php?img=<?php echo str_replace(get_bloginfo("url") . '/',"",$new_feat_image); ?>"><img src="<?php echo $full_image[0] ?>" style="padding:10px 10px 2px 10px"  /><?php echo get_str_downloadimg()?></a>
              </div>
      			</div>
      		</div>
      	</div> 
