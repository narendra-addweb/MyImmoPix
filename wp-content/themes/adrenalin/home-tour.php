...
<div class="col-lg-7 col-md-6 col-sm-12" >
	...
	<h3>The 4 steps for better real estate photos.</h3>
	
	
	
	<ul>
	
	<li><img src="<?php echo $upload_dir['baseurl']; ?>/icon/icon1.jpg" />Create a free account</li>
	<li><img src="<?php echo $upload_dir['baseurl']; ?>/icon/icon2.jpg" />Upload your photos</li>
	<li><img src="<?php echo $upload_dir['baseurl']; ?>/icon/icon3.jpg" />Purchase credits and order the service</li>
	<li><img src="<?php echo $upload_dir['baseurl']; ?>/icon/icon4.jpg" />Your edited photos reach you within 24 hours</li></div>
