...
if(isset($_POST['update'])  && $_POST['update']!='')
{
	...
	if(!empty($your_project_title)){
		echo '<script>document.location.href="'.get_bloginfo("url").'/project/?your_project_title='.$your_project_title.'"</script>';
		exit;
	}else{
		echo '<script>document.location.href="'.get_bloginfo("url").'/project/"</script>';
		exit;	
	}
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="entry-content">
      ...
      <div class="col-lg-12 col-md-12 prjtitle"><strong><?php echo $head;?></strong></div>
        ...
        <?php
		//$your_project_title = get_the_title($_POST['postid']);
	...
	if($seconds>=86400)
	{
		...
		$val = get_string_day($days);
		 
	}
	else if($seconds < 86400 && $seconds >=3600   )
	{
		$hours = intval(intval($seconds) / (3600));	
		$val = get_string_hours($hours);
		
	}
	else if($seconds<3600 && $seconds>=60 ) 
	{
		$minutes = intval(intval($seconds) / (60));	
		$val = get_string_minutes($minutes);
	...
	?>
       ...
       <div class="col-lg-10 col-md-10 color-bg"> 
            ...
            <div class="col-lg-3 col-md-3 pull-right"><strong><?php echo $val;?></strong></div>
        </div>
       </div>
       <?php } else {?>
       ...
       <div class="col-lg-10 col-md-10 color-bg"> 
            ...
            <div class="col-lg-3 col-md-3 pull-right myfont"><strong><?php echo $val;?></strong></div>
        </div>
       </div>
