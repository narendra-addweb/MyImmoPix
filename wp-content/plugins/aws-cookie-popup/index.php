...
Description: Open cookie notification message popup with multi language support
Version: 1.0
...
class AWSCookies {
    ...
    var $defaults = array(
        'title' => "Cookies",
        'message' => "This website uses cookies to ensure a smooth service. By further browsing you accept using the cookies of this website.",
        'position' => "top"
    );
    ...
    function __construct() {
         ...
         */
        load_theme_textdomain( $this->namespace, COOKIES_DIRNAME . '/languages' );
...
register_deactivation_hook( __FILE__, array( 'AWSCookies', 'deactivate' ) );
