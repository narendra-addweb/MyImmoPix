...
(function($){
    $.fn.lightbox = function(options) {
        ...
        //Check JQuery current version is bigger then mine(1.7) OR not...?
        var resultJQVersion = compareJQVersion($.fn.jquery,"1.7.0") > 0 ? true : false;
...
//This JQuery function will return bigger then '0' when current version is bigger then mine version...
function compareJQVersion(currentJSVersion, mineVersion){
    var arrCurrVersion = currentJSVersion.split('.');
    var arrMineVersion = mineVersion.split('.');
    var intCurrVersion = (100000000 * parseInt(arrCurrVersion[0])) + (1000000 * parseInt(arrCurrVersion[1])) + (10000 * parseInt(arrCurrVersion[2]));
    var intMineVersion = (100000000 * parseInt(arrMineVersion[0])) + (1000000 * parseInt(arrMineVersion[1])) + (10000 * parseInt(arrMineVersion[2]));

    if (intCurrVersion > intMineVersion) {
        return 1;
    }else if(intCurrVersion < intMineVersion){
        return -1;
    }else{
        return 0;
    }
