...
qq.log = function(e, t) {
    "use strict";
    window.console && (!t || t === "info" ? window.console.log(e) : window.console[t] ? window.console[t](e) : window.console.log("<" + t + "> " + e))
};
...
qq.extend(qq.FineUploader.prototype, {
    ...
    _onComplete: function(e, t, n, r) {
        ...
        if (n.success) {//alert(n.attachment_url);
			var val = n.attachment_url;
            jQuery('.mythumb_cls').append("<li><img src="+val+" /></li>");
			jQuery('.nextclass').show();
            jQuery('.qq-upload-button').hide();//Hide 'CHOOSE' button...
            jQuery('.topmargin-upload').css('margin-top', '-50px');//Overwrite css for adjust button position...
            jQuery('.mylink').addClass('doblock');
           
		   // by ayaz 
		   qq(i).addClass('displaynone');
...
jQuery(function(e) {
    e(window).load(function() {
		if(jQuery('.vc_transform').attr("lang") == 'nl-NL')
		{
			var mytext = "FOTO'S SELECTEREN";
		}
		else if(jQuery('.vc_transform').attr("lang") == 'en-US')
		{
			var mytext = "CHOOSE PHOTOS";
		}

		else if(jQuery('.vc_transform').attr("lang") == 'fr-FR')
		{
			var mytext = " SELECTIONNER DES PHOTOS";
		}
                    ...
                    onComplete: function(t, n, r) {
                        if (r.success) {
                            var i = e("#wp_multi_file_uploader").parent("form"),
                                ...
                                o = s.data("filecount"),
                                u = r.attachmentId;
                            i.append('<input type="hidden" name="wp_multi_file_uploader_' + o + '" value="' + u + '">');
